                    ...
                    {!isLoggedIn ? (
                        ...
                        >
                            ...
                            <p className="text-text-secondary text-sm leading-relaxed max-w-xs mx-auto">
                                Your comment has been submitted to <strong>genuinesugarmummies.co.ke</strong> and is <strong>awaiting admin approval</strong>.
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3">
                            ...
                            <textarea
                                ...
                                placeholder="Write your comment... This will be posted on genuinesugarmummies.co.ke after admin approval."
                                maxLength={1000}
                                rows={4}
                            ...
                            <p className="text-[10px] text-text-muted leading-relaxed flex items-start gap-1.5">
                                ...
                                Comments are sent to genuinesugarmummies.co.ke for moderation. An admin will review and approve your comment before it appears publicly.
                            </p>
                            <button
                                type="submit"
